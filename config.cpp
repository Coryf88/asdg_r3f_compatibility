...
class CfgWeapons
{
	...
	class R3F_Famas_F1: Rifle_Base_F
	{
		reloadMagazineSound[]=
		{
			"A3\Sounds_F\arsenal\weapons\Rifles\Mk20\reload_Mk20",1,1,10
		};
	...
	class R3F_FRF2: Rifle_Base_F
	{
		reloadMagazineSound[]=
		{
			"A3\Sounds_F\arsenal\weapons\LongRangeRifles\M320\M320_reload",1,1,10
		};
	...
	class R3F_Minimi: Rifle_Base_F
	{
		...
		reloadMagazineSound[]=
		{
			"A3\Sounds_F_Exp\arsenal\weapons\Machineguns\SyndikatLMG\SyndikatLMG_Reload",1,1,10
		};
	...
	class R3F_HK417M: Rifle_Base_F
	{
		reloadMagazineSound[]=
		{
			"A3\Sounds_F_Exp\arsenal\weapons\Rifles\SPAR_17\SPAR_17_reload",1,1,10
		};
	...
	class R3F_MP5SD: Rifle_Base_F
	{
		reloadMagazineSound[]=
		{
			"A3\Sounds_F_Exp\arsenal\weapons\SMGs\Rogue9\Rogue9_Reload",1,1,10
		};
